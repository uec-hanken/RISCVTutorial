...
// X is the opcode
#define CUSTOMX(X, xd, xs1, xs2, rd, rs1, rs2, funct7) \
  CUSTOMX_OPCODE(X)                     |             \
  (rd                 << (7))           |             \
  (xs2                << (7+5))         |             \
  (xs1                << (7+5+1))       |             \
...
#define ROCC_INSTRUCTION_DSS(X, rd, rs1, rs2, funct7) \
	ROCC_INSTRUCTION_R_R_R(X, rd, rs1, rs2, funct7, 10, 11, 12)

#define ROCC_INSTRUCTION_DS(X, rd, rs1, funct7) \
	ROCC_INSTRUCTION_R_R_I(X, rd, rs1, 0, funct7, 10, 11)

#define ROCC_INSTRUCTION_D(X, rd, funct7) \
	ROCC_INSTRUCTION_R_I_I(X, rd, 0, 0, funct7, 10)

#define ROCC_INSTRUCTION_SS(X, rs1, rs2, funct7) \
	ROCC_INSTRUCTION_I_R_R(X, 0, rs1, rs2, funct7, 11, 12)

#define ROCC_INSTRUCTION_S(X, rs1, funct7) \
	ROCC_INSTRUCTION_I_R_I(X, 0, rs1, 0, funct7, 11)

#define ROCC_INSTRUCTION(X, funct7) \
	ROCC_INSTRUCTION_I_I_I(X, 0, 0, 0, funct7)
